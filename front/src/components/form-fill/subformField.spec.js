...
test('rejects nested subform and divider', () => {
  ...
  assert.equal(isSubformChildType('member'), true)
  assert.equal(isSubformChildType('member-multiple'), true)
  assert.equal(isSubformChildType('dept'), true)
  assert.equal(isSubformChildType('dept-multiple'), true)
